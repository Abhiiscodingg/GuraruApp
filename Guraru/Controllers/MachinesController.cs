...
namespace Guraru.Controllers
{
    public class MachinesController : Controller
    {
        ...
        public MachinesController(GuraruContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MachineId,MachineName,IsDeleted")] Machine machine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MachineId,MachineName,IsDeleted")] Machine machine)
        {
